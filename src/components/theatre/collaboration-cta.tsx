      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Interested in
            <br />
            <span className="text-red-500">collaborating?</span>
          </h2>
          <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
            Whether you&apos;re a playwright, director, venue, or organization
            looking to develop a theatrical production, we&apos;d love to
            discuss how we can bring your vision to life through innovative and
            inclusive theatre.
          </p>
          ...
          >
            <Button
              ...
              aria-label="Get in touch about theatre collaboration"
              asChild
            >
              <Link href="/contact">
          ...
          >
            {[
              { icon: Users, label: "Collaborative Process", value: "Always" },
              {
                icon: MessageCircle,
                label: "Response Time",
                value: "< 48 hours",
